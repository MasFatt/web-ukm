<div class="card card-info">
    <div class="card-header">
        <h3 class="card-title">
            <i class="fa fa-table"></i> Data KDR Putra
        </h3>
    </div>
    <!-- /.card-header -->
    <div class="card-body">
        <div class="table-responsive">
            <div>
                <a href="?page=add-kdr2" class="btn btn-primary">
					<i class="fa fa-edit"></i> Tambah Data
				</a>
				<a href="?page=data-kdr2" class="btn btn-info">
                    <i class="fa fa-edit"></i> Semua Data KDR
                </a>
                <a href="?page=data-kdr_putra2" class="btn btn-success">
                    <i class="fa fa-edit"></i> KDR Putra
                </a>
                <a href="?page=data-kdr_putri2" class="btn btn-danger ">
				...
				<tbody>
					...
					?>
						...
						<tr>
							...
							<td>
								<a href="?page=view-kdr2&kode=<?php echo $data['id_kdr']; ?>" title="Detail" class="btn btn-info btn-sm">
									<i class="fa fa-eye"></i>
								</a>
								</a>
								<a href="?page=edit-kdr2&kode=<?php echo $data['id_kdr']; ?>" title="Ubah" class="btn btn-success btn-sm ">
									<i class="fa fa-edit"></i>
								</a>
								<a href="?page=del-kdr2&kode=<?php echo $data['id_kdr']; ?>" onclick="return confirm('Apakah anda yakin hapus data ini ?')" title="Hapus" class="btn btn-danger btn-sm">
