<div class="card card-info">
	<div class="card-header">
		<h3 class="card-title">
			<i class="fa fa-table"></i> Data LPJ Pengurus
		</h3>
	</div>
	<!-- /.card-header -->
	<div class="card-body">
		<div class="table-responsive">
			<div>
				...
				<a href="?page=data_lpj_kegiatan" class="btn btn-success">
					<i class="fa fa-edit"></i> LPJ Kegiatan
				</a>
				<a href="?page=data_lpj_pengurus" class="btn btn-danger ">
				...
				<tbody>
					...
					?>
						...
						<tr>
							...
							<td>
								<a href="?page=view-lpj&kode=<?php echo $data['id_lpj']; ?>" title="Detail" class="btn btn-info btn-sm">
									<i class="fa fa-eye"></i>
								</a>
								</a>
								<a href="?page=edit-lpj&kode=<?php echo $data['id_lpj']; ?>" title="Ubah" class="btn btn-success btn-sm ">
									<i class="fa fa-edit"></i>
								</a>
								<a href="?page=del-lpj&kode=<?php echo $data['id_lpj']; ?>" onclick="return confirm('Apakah anda yakin hapus data ini ?')" title="Hapus" class="btn btn-danger btn-sm">
