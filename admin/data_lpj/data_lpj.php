		...
		<div>
            ...
            ?>
					...
					<tr>
						...
						<td>
							<a href="?page=view-lpj&kode=<?php echo $data['id_lpj']; ?>" title="Detail"
							...
							<a href="?page=del-lpj&kode=<?php echo $data['id_lpj']; ?>" onclick="return confirm('Apakah anda yakin hapus data ini ?')"
